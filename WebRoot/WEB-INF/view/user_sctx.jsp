    ...
    <div class="user-cnb">
      <div class="block-center clearfix">
        <div class="user-leftc">
          <ul>
            <li><a class="active" href="${pageContext.request.contextPath}/path/user">个人设置</a></li>
            <li><a href="${pageContext.request.contextPath}/path/user_xgmm">修改密码</a></li>
            <li><a href="${pageContext.request.contextPath}/path/user_order">我的订单</a></li>
          ...
          <div class="basic-box">
            <div class="ty-tabnav clearfix">
              <ul>
                ...
                <li><a class="active" href="${pageContext.request.contextPath}/path/user_sctx">上传头像</a></li>
                <li><a href="${pageContext.request.contextPath}/path/user_xgmm">修改密码</a></li>
              </ul>
            </div>
            <div class="user-dlc">
              <div class="bk100"></div>
              <center><img src="img/avatar.png" class="ty-avatar"></center>
              <div class="bk80"></div>
              <div class="btn-b">
                <a href="#" class="sctx">上传头像</a>
                <a href="#" class="bctx">保存</a>
              </div>
              <div class="bk25"></div>
              <div class="tip">
                <span>*</span>注：只支持jpg、png、jpeg格式，文件不超过2MB
              </div>
            </div>
          </div>
          <div class="bk80"></div>

    ...
    <div class="user-cnb">
      <div class="block-center clearfix">
        ...
        <div class="user-rightc">
          <div class="bk40"></div>
          <div class="message-artc">
            <div class="bt">Small RNA测序</div>
            <div class="content">      Small RNA是一类重要的体内调节分子，主要包括miRNA、piRNA和siRNA。已发货请注意查收！Small RNA是一类重要的体内调节分子，主要包括miRNA、piRNA和siRNA。已发货请注意查收！Small RNA是一类重要的体内调节分子，主要包括miRNA、piRNA和siRNA。已发货请注意查收！Small RNA是一类重要的体内调节分子，主要包括miRNA、piRNA和siRNA。已发货请注意查收！</div>
